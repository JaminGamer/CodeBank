...
void Mesh::SetupAttributes(ShaderProgram* shader)
{
	...
	GLuint aPos = glGetAttribLocation(t_ShaderHandle, "a_Position");
	...
	GLuint aColor = glGetAttribLocation(t_ShaderHandle, "a_Color");
	if (aColor != -1)
	{
	...
	GLuint aUV = glGetAttribLocation(t_ShaderHandle, "a_UV");
	if (aUV != -1)
	{
	...
	GLuint aNormal = glGetAttribLocation(t_ShaderHandle, "a_Normal");
	if (aNormal != -1)
	{
